      ...
      <div className='flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0'>
        ...
        <div className='inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full'>
          ...
          <div className='bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse justify-center'>
            <button
              type='button'
              className='w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-6 py-2 bg-[#FFB800] text-base font-medium text-white hover:bg-[#F0AE00] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#FFB800] sm:ml-3 sm:w-auto sm:text-sm'
              onClick={onConfirm}
              disabled={isLoading}
            >
